...
Full architecture, event contracts, and the project-wide decision record live in [`../documentation/`](../documentation/) — see [`DOCUMENTATION.en-US.md`](../documentation/narrative/DOCUMENTATION.en-US.md) and [`instructions.md`](../documentation/spec/instructions.md) §4.5.
