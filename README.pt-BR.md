...
A arquitetura completa, os contratos de eventos e o registro de decisões do projeto vivem no repositório `documentation` — [`github.com/tc2-fiap/documentation`](https://github.com/tc2-fiap/documentation) (ou `../documentation/` se você o tiver clonado como irmão) — ver [`DOCUMENTATION.pt-BR.md`](https://github.com/tc2-fiap/documentation/blob/main/narrative/DOCUMENTATION.pt-BR.md) e [`instructions.md`](https://github.com/tc2-fiap/documentation/blob/main/spec/instructions.md) §4.5 (em inglês).
